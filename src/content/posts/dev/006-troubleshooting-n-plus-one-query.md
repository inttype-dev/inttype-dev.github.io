...
description: |-
  더미 데이터가 적은 상황에서도 특정 페이지 로딩이 느려지는 문제가 발생했습니다.
  원인을 추적해 N+1 문제를 확인하고, Application-side Join(Bulk Query) 방식으로 조회 전략을 개선한 경험을 정리했습니다.
pubDate: 2025-12-22T23:22:00
tags: ["n+1", "sql", "query", "performance", "troubleshooting", "bulk-query"]
category: 개발
draft: false
lang: kr
---
