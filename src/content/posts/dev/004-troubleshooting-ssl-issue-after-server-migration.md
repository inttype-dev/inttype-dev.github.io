...
description: |-
  윈도우 IIS 환경에서 Docker + Nginx 환경으로 이전 후 외부 API 응답이 실패하는 문제가 발생했습니다.
  원인 분석 과정과 SSL 보안 설정으로 이어진 트러블슈팅 경험을 정리했습니다.
pubDate: 2025-12-12T22:45:00
tags: ["nginx", "ssl", "tls", "server-migration", "docker", "troubleshooting"]
category: 개발
draft: false
lang: kr
---
