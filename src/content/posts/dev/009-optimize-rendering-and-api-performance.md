...
description: |-
  CSR 구조에서 발생하던 화면 공백 문제를 Streaming SSR로 전환했습니다.
  REST API 쿼리 최적화를 통해 응답 시간을 개선한 경험을 정리했습니다.
pubDate: 2026-01-05T15:00:00
tags: ["csr", "ssr", "streaming-ssr", "performance", "optimization", "sveltekit"]
category: 개발
draft: false
lang: kr
---
...
| 구분 | 실행 결과 |
|---|---|
| **최적화 전** | ![Before Optimization (이미지 준비 중)](/images/fallbackImage_mascot.png) |
| **최적화 후** | ![After Optimization (이미지 준비 중)](/images/fallbackImage_mascot.png) |
