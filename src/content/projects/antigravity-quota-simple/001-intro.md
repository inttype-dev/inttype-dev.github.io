---
title: "Antigravity Quota Simple 프로젝트 소개 및 개발 배경"
description: "Antigravity 상태 표시줄에서 Quota를 바로 확인하는 확장 프로그램 소개 및 개발 배경"
...
Antigravity Quota를 상태 표시줄에서 바로 확인할 수 있는 확장 프로그램입니다.
